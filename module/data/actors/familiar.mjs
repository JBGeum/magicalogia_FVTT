 ...
 * 체력/설정은 BaseActorModel(health, biography) 상속. 부스트 수·임시 체력은
 * 표시용(자동 반영 없음). features는 고유 기능 설명(표시만).
 */
export class FamiliarDataModel extends BaseActorModel {
  static defineSchema() {
    return {
      ...
      tempHealthGrant: new fields.NumberField({ initial: 0, integer: true }),
